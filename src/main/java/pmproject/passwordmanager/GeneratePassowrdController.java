...
public class GeneratePassowrdController {
    @FXML
    ...
    protected void onGeneratePasswordClicked() {
        ...
        boolean includeNumber = cbNumbers.isSelected();
        ...
        String generatedPassword = onGeneratePsswdBtnPressed(includeNumber, includeUppercase, includeLowercase, includeSymbols, length);
        passwordField.setText(generatedPassword);
    }
    @FXML
    protected void onCopyPasswordClicked() {
        ...
        if (password != null && !password.isEmpty()) {
            ...
            System.out.println("Password copied to clipboard: " + password);
        }
    }
}
